...
module PortfolioData.Subscription exposing (ClassificationsByPkRequiredArguments, ClassificationsOptionalArguments, ExperienceClassificationsByPkRequiredArguments, ExperienceClassificationsOptionalArguments, ExperiencesByClassificationOptionalArguments, ExperiencesByClassificationRequiredArguments, ExperiencesByPkRequiredArguments, ExperiencesOptionalArguments, classifications, classifications_by_pk, experience_classifications, experience_classifications_by_pk, experiences, experiences_by_classification, experiences_by_pk)
...
-}
classifications : (ClassificationsOptionalArguments -> ClassificationsOptionalArguments) -> SelectionSet decodesTo PortfolioData.Object.Classifications -> SelectionSet (List decodesTo) RootSubscription
...
-}
classifications_by_pk : ClassificationsByPkRequiredArguments -> SelectionSet decodesTo PortfolioData.Object.Classifications -> SelectionSet (Maybe decodesTo) RootSubscription
...
-}
experience_classifications : (ExperienceClassificationsOptionalArguments -> ExperienceClassificationsOptionalArguments) -> SelectionSet decodesTo PortfolioData.Object.Experience_classifications -> SelectionSet (List decodesTo) RootSubscription
...
-}
experience_classifications_by_pk : ExperienceClassificationsByPkRequiredArguments -> SelectionSet decodesTo PortfolioData.Object.Experience_classifications -> SelectionSet (Maybe decodesTo) RootSubscription
...
-}
experiences : (ExperiencesOptionalArguments -> ExperiencesOptionalArguments) -> SelectionSet decodesTo PortfolioData.Object.Experiences -> SelectionSet (List decodesTo) RootSubscription
...
-}
experiences_by_classification : (ExperiencesByClassificationOptionalArguments -> ExperiencesByClassificationOptionalArguments) -> ExperiencesByClassificationRequiredArguments -> SelectionSet decodesTo PortfolioData.Object.Experiences -> SelectionSet (List decodesTo) RootSubscription
...
-}
experiences_by_pk : ExperiencesByPkRequiredArguments -> SelectionSet decodesTo PortfolioData.Object.Experiences -> SelectionSet (Maybe decodesTo) RootSubscription
